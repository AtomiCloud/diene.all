...
| 5   | Dart scripts                     | 12    | `scripts/ci/` × `analyze.sh`, `deadcode.sh`, `nix-check.sh`, `package-validate.sh`, `publish.sh`, `test-all.sh`, `test.sh`; `scripts/local/` × `deadcode.sh`; `scripts/release/format-changelog.sh`; `scripts/validate/` × `dart-package.sh`, `publish-version.sh`, `release-policy.sh`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | node-owned                                                                      |
...
Group total: 23 + 7 + 4 + 28 + 12 + 1 + 2 = **77**.
