...
final class SessionController extends ChangeNotifier {
  SessionController({
    ...
    Duration accessLifetime = TokenLifetimes.access,
    Duration refreshLifetime = TokenLifetimes.refresh,
  ...
  Future<Result<SessionTokens>> signIn({
    ...
    try {
      ...
      notifyListeners();
      return Success<SessionTokens>(issued);
  ...
  Result<SessionTokens> _fail({
    ...
    _problem = problem;
    notifyListeners();
    return Failure<SessionTokens>(problem);
  }
