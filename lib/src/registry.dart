...
final class ProblemType {
  ...
  /// Stable identifier, e.g. `entity-not-found`.
  final String id;
...
class DuplicateProblemTypeError extends StateError {
  DuplicateProblemTypeError(String id) : super('problem type already registered: $id');
}

/// Thrown when resolving an unknown problem id.
class UnknownProblemTypeError extends StateError {
  UnknownProblemTypeError(String id) : super('no problem type registered for id: $id');
}
