...
This branch ships native Kubernetes ValidatingAdmissionPolicies and bindings with an ordinary product testing pyramid.

- `task test:unit` — run schema, lint, render, and CEL conformance fixtures.
- `task test:int` — run the reserved, isolated k3d admission proof.
