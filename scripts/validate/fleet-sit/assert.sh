  ...
  jq -n \
    ...
    '{
      ...
      deviations: [
        ...
        "before L5 the throwaway harness scales down the Application controller and lets the ApplicationSet controller recreate only platform-sitother, clearing the intentionally CRD-light initial retry; after the tag move it restores the controller and requires a new automatic C4 operation",
