...
if [ "${mode}" = "pack-content" ]; then
  ...
  for expected in \
    ...
    package/skills/diene-bun-lib-usage/assets/consumer.ts \
    package/skills/diene-bun-lib-usage/assets/consumer.cjs \
    package/skills/diene-bun-lib-usage/assets/test-helper.md; do
