#!/usr/bin/env bash
# Downstream C0 projection generator for diene_e2e.
...
# under packages/diene_e2e/, so CWD-relative paths cannot address both.
set -euo pipefail
...
outdir="packages/diene_e2e/test/fixtures/c0"
