...
rg -q 'packages/diene_problems/CHANGELOG.md' atomi_release.yaml || {
  echo "❌ packages/diene_problems/CHANGELOG.md is absent from semantic-release assets" >&2
  exit 1
}
rg -q 'packages/diene_problems/pubspec.yaml' atomi_release.yaml || {
  echo "❌ packages/diene_problems/pubspec.yaml is absent from semantic-release assets" >&2
  exit 1
}
