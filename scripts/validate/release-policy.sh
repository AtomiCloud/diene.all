...
rg -q 'packages/diene_api_engine/CHANGELOG.md' atomi_release.yaml || {
  echo "❌ packages/diene_api_engine/CHANGELOG.md is absent from semantic-release assets" >&2
  exit 1
}
rg -q 'packages/diene_api_engine/pubspec.yaml' atomi_release.yaml || {
  echo "❌ packages/diene_api_engine/pubspec.yaml is absent from semantic-release assets" >&2
  exit 1
}
