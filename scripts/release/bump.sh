...
# PACKAGE_ROOT mirrors the repo-root layout (VERSION + packages/diene_api_engine/
...
yq -i ".version = \"${version}\"" "${root_dir}/packages/diene_api_engine/pubspec.yaml"

echo "✅ VERSION and packages/diene_api_engine/pubspec.yaml stamped to ${version}"
