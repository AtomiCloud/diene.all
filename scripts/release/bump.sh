...
# PACKAGE_ROOT mirrors the repo-root layout (VERSION + packages/diene_core_utils/
...
yq -i ".version = \"${version}\"" "${root_dir}/packages/diene_core_utils/pubspec.yaml"

echo "✅ VERSION and packages/diene_core_utils/pubspec.yaml stamped to ${version}"
