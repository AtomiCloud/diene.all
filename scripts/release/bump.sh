...
# PACKAGE_ROOT mirrors the repo-root layout (VERSION + packages/diene_e2e/
...
yq -i ".version = \"${version}\"" "${root_dir}/packages/diene_e2e/pubspec.yaml"

echo "✅ VERSION and packages/diene_e2e/pubspec.yaml stamped to ${version}"
