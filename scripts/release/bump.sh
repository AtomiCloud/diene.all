...
# PACKAGE_ROOT mirrors the repo-root layout (VERSION + packages/diene_problems/
...
yq -i ".version = \"${version}\"" "${root_dir}/packages/diene_problems/pubspec.yaml"

echo "✅ VERSION and packages/diene_problems/pubspec.yaml stamped to ${version}"
