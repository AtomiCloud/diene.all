...
# PACKAGE_ROOT mirrors the repo-root layout (VERSION + packages/diene_config/
...
yq -i ".version = \"${version}\"" "${root_dir}/packages/diene_config/pubspec.yaml"

echo "✅ VERSION and packages/diene_config/pubspec.yaml stamped to ${version}"
