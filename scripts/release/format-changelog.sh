...
#
# This script runs from the release.hooks.prepare step. The v2 release runner
# invokes it AFTER the changelog entry has been written and BEFORE the release
# commits its assets, so the bytes that land in the release commit are already
