...
func main() {
	...
	if err != nil {
		fail("load application config", err)
	}
	...
	if err != nil {
		fail("construct domain problems", err)
	}
	...
	if err != nil {
		fail("marshal Problem catalog", err)
	}
	...
	if err := os.MkdirAll(filepath.Dir(target), 0o750); err != nil {
		fail("create Problem catalog directory", err)
	}
	if err := os.WriteFile(target, encoded, 0o600); err != nil {
		fail("write Problem catalog", err)
	}
}
