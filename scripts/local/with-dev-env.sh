...
export ATOMI_AUTH__IDP__MANAGEMENT__CLIENT_ID="${ATOMI_AUTH__IDP__MANAGEMENT__CLIENT_ID:-local-management}"
export ATOMI_AUTH__IDP__MANAGEMENT__CLIENT_SECRET="${ATOMI_AUTH__IDP__MANAGEMENT__CLIENT_SECRET:-local-secret}"
export ATOMI_AUTH__MINTING__CLIENT_ID="${ATOMI_AUTH__MINTING__CLIENT_ID:-local-go-consumer}"
export ATOMI_AUTH__MINTING__CLIENT_SECRET="${ATOMI_AUTH__MINTING__CLIENT_SECRET:-local-secret}"
