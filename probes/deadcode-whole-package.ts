...
// it as dead code.
const MEMBER = 'packages/diene_problems';
const WHOLE_PASS =
  "nix develop .#ci --no-write-lock-file -c bash -lc 'cd packages/diene_problems && dart run dart_code_linter:metrics check-unused-code lib test example && dart run dart_code_linter:metrics check-unused-files lib test example'";
