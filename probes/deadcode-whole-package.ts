...
// it as dead code.
const MEMBER = 'packages/diene_e2e';
const WHOLE_PASS =
  "nix develop .#ci --no-write-lock-file -c bash -lc 'cd packages/diene_e2e && flutter pub run dart_code_linter:metrics check-unused-code lib test example && flutter pub run dart_code_linter:metrics check-unused-files lib test example'";
