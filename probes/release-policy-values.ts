...
// Gate: the real release-policy validator asserts the per-node schema-v2
// release.changelog.path, release.changelog.title prefix, and version-stamping
// release.hooks.prepare values. The mechanism cascades; each descendant keeps its
// own local values and must satisfy it.
