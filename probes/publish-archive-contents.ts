...
const DRY_RUN_HAS_SKILL =
  'nix develop .#ci --no-write-lock-file -c bash -lc \'cd packages/diene_api_engine && out=$(flutter pub publish --dry-run 2>&1 || true); echo "$out" | grep -q diene-api-engine-usage\'';
