...
| global.serviceTree | object | `{"layer":"1","module":"reloader","platform":"sample","service":"chlorine"}` | Stable four-slot service-tree projection. Landscape and cluster arrive from independent overlays. |
| global.serviceTree.layer | string | `"1"` | Architecture layer. |
| global.serviceTree.module | string | `"reloader"` | Module name. |
| global.serviceTree.platform | string | `"sample"` | Platform identity. Always sourced from the release namespace. |
