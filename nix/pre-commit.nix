...
pre-commit-lib.run {
  ...
  hooks = {
    ...
    a-dart-format = {
      ...
      files = "^packages/diene_interfaces/(lib|test|example|tool)/.*[.]dart$";
      pass_filenames = true;
      language = "system";
    };
    ...
    a-dart-analyze = {
      ...
      files = "^packages/diene_interfaces/(lib|test|example|tool)/.*[.]dart$|^(packages/diene_interfaces/(pubspec|analysis_options)|pubspec)[.]yaml$";
      pass_filenames = false;
      language = "system";
    };
    ...
    a-dart-test = {
      ...
      files = "^packages/diene_interfaces/(lib|test)/.*[.]dart$|^(packages/diene_interfaces/pubspec|pubspec)[.]yaml$";
      pass_filenames = false;
      language = "system";
    };
    ...
    a-dart-package = {
      ...
      files = "^(packages/diene_interfaces/(lib/.*[.]dart|tool/gen_c0_projection[.]dart|test/fixtures/c0/.*|pubspec[.]yaml|README[.]md|CHANGELOG[.]md|LICENSE|skills/.*|doc/interfaces[.]md)|contracts/c0/.*|scripts/validate/c0-release[.]sh|[.]prettierignore|pubspec[.]yaml|VERSION)$";
      pass_filenames = false;
      language = "system";
    };
