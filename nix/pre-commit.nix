...
pre-commit-lib.run {
  ...
  hooks = {
    ...
    a-dart-format = {
      ...
      files = "^packages/diene_interfaces/(lib|test|example)/.*[.]dart$";
      pass_filenames = true;
      language = "system";
    };
    ...
    a-dart-package = {
      ...
      files = "^(packages/diene_interfaces/(lib/.*[.]dart|pubspec[.]yaml|README[.]md|CHANGELOG[.]md|LICENSE|skills/.*|doc/interfaces[.]md)|pubspec[.]yaml|VERSION)$";
      pass_filenames = false;
      language = "system";
    };
  };
