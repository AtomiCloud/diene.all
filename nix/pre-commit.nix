...
pre-commit-lib.run {
  ...
  hooks = {
    ...
    a-dart-format = {
      ...
      files = "^packages/diene_api_engine/(lib|test|example)/.*[.]dart$";
      pass_filenames = true;
      language = "system";
    };
    ...
    a-dart-analyze = {
      ...
      files = "^packages/diene_api_engine/(lib|test|example|tool)/.*[.]dart$|^(packages/diene_api_engine/(pubspec|analysis_options)|pubspec)[.]yaml$";
      pass_filenames = false;
      language = "system";
    };
    ...
    a-dart-test = {
      ...
      files = "^packages/diene_api_engine/(lib|test)/.*[.]dart$|^(packages/diene_api_engine/pubspec|pubspec)[.]yaml$";
      pass_filenames = false;
      language = "system";
    };
