...
void main() {
  ...
  group('AppHandoffRedeemResponse', () {
    ...
    test('round-trips through json', () {
      ...
      final AppHandoffRedeemResponse back =
          AppHandoffRedeemResponse.fromJson(resp.toJson());
      expect(back.token, 't');
  ...
  group('AppHandoffExpired', () {
    test('carries the fixed no-oracle 410 body with injected type uri', () {
      // Arrange.
      final AppHandoffExpired problem =
          AppHandoffExpired.withType('https://example/AppHandoffExpired');
      // Act.
