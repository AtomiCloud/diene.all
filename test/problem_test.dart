...
void main() {
  group('Problem envelope', () {
    test('toJson serializes RFC 9457 members plus the data/recoverable extensions', () {
      // Arrange
      const problem = Problem(
        type: 'https://docs.example/docs/raichu/dotnet/user/api/v1/entity-not-found',
    ...
    test('fromJson round-trips a serialized envelope (data included)', () {
      const problem = Problem(
        ...
        status: 409,
        recoverable: true,
        data: <String, Object?>{'nested': <String, Object?>{'a': 1}},
      );
    ...
    test('equality is structural across all fields', () {
      const a = Problem(type: 't', title: 'T', status: 500, data: <String, Object?>{'x': 1});
      const b = Problem(type: 't', title: 'T', status: 500, data: <String, Object?>{'x': 1});
      const c = Problem(type: 't', title: 'T', status: 500, data: <String, Object?>{'x': 2});
      expect(a, b);
