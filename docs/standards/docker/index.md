...
```bash
pls docker:build:main            # -> diene-dotnet-base:local
pls docker:build:main -- 1       # -> diene-dotnet-base:local-1
pls docker:build:main -- hello   # -> diene-dotnet-base:local-hello
```
