...
```bash
task docker:build:main            # -> diene-dotnet-base:local
task docker:build:main -- 1       # -> diene-dotnet-base:local-1
task docker:build:main -- hello   # -> diene-dotnet-base:local-hello
```
