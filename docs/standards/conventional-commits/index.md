...
`atomi_release.yaml` remains the machine-readable source of truth;
`docs/developer/CommitConventions.md` is generated from it by
`releaser conventions` and must not be edited by hand.
