...
{{- define "flutterPrimordial.resourceName" -}}
{{- $root := .root -}}
...
{{- define "flutterPrimordial.grafanaPrefix" -}}
...
{{- define "flutterPrimordial.grafanaFolderUid" -}}
{{- printf "%s-folder" (include "flutterPrimordial.grafanaPrefix" .) -}}
{{- end -}}

{{/* Service-tree labels only; every key is prefixed by labelPrefix. */}}
{{- define "flutterPrimordial.serviceTreeLabels" -}}
{{- $prefix := include "flutterPrimordial.labelPrefix" . -}}
...
{{- define "flutterPrimordial.labels" -}}
helm.sh/chart: {{ include "flutterPrimordial.chart" . }}
...
{{- include "flutterPrimordial.serviceTreeLabels" . }}
{{- end -}}

{{/* Service-tree annotations for every owned resource. */}}
{{- define "flutterPrimordial.annotations" -}}
{{ include "flutterPrimordial.serviceTreeLabels" . | trim }}
{{- end -}}
...
{{- define "flutterPrimordial.alertLabels" -}}
{{- range $key, $value := .Values.serviceTree }}
{{ $key }}: {{ $value | quote }}
{{- end }}
{{- end -}}
